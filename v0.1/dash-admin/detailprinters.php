        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Detail Printer</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"><a href="tambah-printer.php"><i class="fas fa-plus"></i> Tambah Printer</a></h3>
                ...
                <div class="card-tools">
                  <ul class="pagination pagination-sm float-right">
                    <?php
                      ...
                      $myquery = $ubuntudbconn->query("SELECT * FROM tblprinters INNER JOIN tbl_os on OSType=oscode WHERE pcode='$pid' LIMIT $mulai, $hal");
                      $QueryTotal = $ubuntudbconn->query("SELECT * FROM tblprinters WHERE pcode='$pid'");
                      $total = $QueryTotal->num_rows;
                      $pages = ceil($total/$hal);
                      for ($i=1; $i<=$pages ; $i++){
                    ?>
                    <li class="page-item"><a class="page-link" href="detailprinters.php?p=<?php echo $i; ?>&id=<?php echo $pid; ?>"><?php echo $i; ?></a></li>
                    <?php
                      }
                    ?>
                  </ul>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <?php
                       if($row['ptype'] == "Driver"){
                        echo "<td>Driver</td>";
                       }elseif($row['ptype'] == "Apps"){
                        echo "<td>Aplikasi</td>";
                       }
                      ?>
                      <td><?php echo $row['language'];?></td>
                      <td><?php echo $row['osname'];?></td>
                      <td><a href="detailprinters.php?id=<?php echo $row['jenisprinter'];?>" class="btn btn-block btn-primary btn-sm" target="_blank">Update Data <?php echo $row['jenisprinter'];?></a></td>
                    </tr>
                  </tbody>
                  <?php
                     }
