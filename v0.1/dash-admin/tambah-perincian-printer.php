    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="./tambah-printer.php" class="nav-link active">
              <i class="nav-icon fas fa-print"></i>
              <p>Tambah Printer</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="./tambah-perincian-printer.php" class="nav-link">
              <i class="nav-icon fas fa-print"></i>
              <p>Tambah Perincian Printer</p>
            </a>
          </li>
              ...
              <form role="form">
                <div class="card-body">
                  <div class="form-group">
                    <label for="NamaPrinter">Nama Printer</label>
                    <input type="text" class="form-control" id="NamaPrinter" name="pname" placeholder="Silahkan Masukan Nama Printer">
                  </div>
                  <div class="form-group">
                    <label>Jenis Produk</label>
                    <select class="form-control" name="ptype">
                      <option value="Driver">Driver</option>
                      <option value="Apps">Software</option>
                    </select>
                  </div>
                  <div class="form-group">
                    <label for="InputGlobal">Bahasa</label>
                    <input type="text" class="form-control" id="Language" name="langs" value="All Language" placeholder="Silahkan Masukan Bahasa" disabled="disabled">
                  </div>                 
                  <div class="form-group">
                    <label>Sistem Operas</label>
                    <select class="form-control" name="OSCrot">
                      <?php
