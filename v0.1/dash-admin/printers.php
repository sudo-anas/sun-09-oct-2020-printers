                ...
                <div class="card-tools">
                  <ul class="pagination pagination-sm float-right">
                    <?php
                      ...
                      for ($i=1; $i<=$pages ; $i++){
                    ?>
                    <li class="page-item"><a class="page-link" href="printers.php?id=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                    <?php
                      }
                    ?>
                  </ul>
                ...
                <table class="table table-head-fixed text-nowrap">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td><?php echo $row['seriprinter'];?></td>
                      <td><a href="<?php echo $row['vendorwebsite'];?>"><?php echo $row['vendorprinter'];?></a></td>
